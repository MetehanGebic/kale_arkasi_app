...
class _RegisterScreenState extends State<RegisterScreen> {
  ...
  final List<Map<String, String>> _mockClubs = [
    {'id': 'e330bece-53ff-4cfd-b4b7-88981df59812', 'name': 'Galatasaray'},
    {'id': '206385cf-d30e-4739-9be9-64eb4b1b36bb', 'name': 'Fenerbahçe'},
    {'id': '45041935-cf22-4a0b-8d59-a5c7f8f94cb4', 'name': 'Beşiktaş'},
    {'id': '7672d5d8-c920-410a-b33a-bc4de8b71d49', 'name': 'Trabzonspor'},
  ];
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _buildTextField(
                      ...
                      validator: (val) => val!.length < 3 ? 'En az 3 karakter olmalı' : null,
                    ),
                    ...
                    DropdownButtonFormField<String>(
                      ...
                      icon: const Icon(Icons.arrow_drop_down_circle, color: turfGreen),
                      ...
                      validator: (val) => val == null ? 'Lütfen takım seçin' : null,
                    ),
                    const SizedBox(height: 32),
